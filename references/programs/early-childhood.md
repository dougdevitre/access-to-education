...
1. Spring transition meetings between preschool/Pre-K providers and kindergarten teachers
2. Kindergarten orientation events for families
3. Home visits by kindergarten teachers (some districts)
4. Staggered entry schedules (first days of school)
5. Information packets for families (school expectations, routines, supplies, bus procedures)
6. Special attention to transitions for children with IEPs, ELLs, foster care, and homeless children
