...
<!-- Canonical source for: ELL instruction, WIDA proficiency levels, sheltered instruction, language objectives, ELL accommodations, ELL curriculum differentiation, newcomer programs, SIOP, Title III, ACCESS testing -->
...
**Step 1:** Identify the content objective (same for all students)
**Step 2:** Write a language objective tiered by proficiency
**Step 3:** Differentiate the task, not the rigor
...
→ For full legal details, see `references/compliance/equity-access.md` §4
→ For Title III funding details, see `references/compliance/funding-programs.md`
→ For WIDA identification basics, see `references/roles/specialists.md` §6
